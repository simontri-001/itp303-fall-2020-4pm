...
<!-- 
confirm() opens up a pop up with two options - cancel or yes
confirm() will return TRUE if user clicks "Yes"
confirm() will return FALSE if user clicks "Cancel"

onclick="return FALSE" will prevent the link from actually redirecting to the page defined in href

onclick="return TRUE" will allow link to redirect to the page
defined by href
 -->
			
<a onclick="return confirm('Are you sure you want to delete this song?')" 
href="delete.php?track_id=<?php echo $row['track_id']; ?>&track_name=<?php echo $row['track'];?>" class="btn btn-outline-danger delete-btn">
				Delete
			</a>
