...
if ( !isset($_POST['track_name']) || empty($_POST['track_name']) 
	...
	// First param are the data types of the user input
	$statement->bind_param("sisi", $_POST['track_name'], $_POST['genre'], $_POST['composer'], $_POST['track_id']);

	// execute() will return false if there was an error
	$executed = $statement->execute();
	if(!$executed) {
		echo $mysqli->error;
	}

	// can still use affected_rows to see how many records were updated in last SQL statement
